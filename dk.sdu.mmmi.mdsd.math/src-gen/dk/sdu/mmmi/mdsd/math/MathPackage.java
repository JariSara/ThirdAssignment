...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL_DEF__PARAMETERS = 1;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.Program#getVariables <em>Variables</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Variables</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Program#getVariables()
   * @see #getProgram()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.ExternalDef#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalDef#getName()
   * @see #getExternalDef()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExternalDef#getParameters <em>Parameters</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Parameters</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalDef#getParameters()
   * @see #getExternalDef()
   * @generated
   */
